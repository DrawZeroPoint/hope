...
namespace hope {
  ...
  typedef pcl::FPFHEstimationOMP<Point_N, Point_N, FeatureFPFH> FeatureEstimationFPFH;
  ...
  typedef pcl::visualization::PointCloudColorHandlerCustom<Point_N> ColorHandler;
  ...
  public:
    ...
    static void calRegionGrowing(const Cloud_XYZRGBN::Ptr& cloud_in, int minsz, int maxsz, int nb, int smooth,
    ...
    template <typename T>
    static void downSampling(T cloud_in, T &cloud_out,
    ...
    static void combineCloud(const Cloud_XYZ::Ptr& cloud_a, const Cloud_XYZ::Ptr& cloud_b, Cloud_XYZ::Ptr &cloud_out);
