...
std::string HighResTimer::reportMicroseconds() const
{
  ...
  oss << description_ << ": " << getMicroseconds() << " microseconds.";
  return oss.str();
}
...
{
  std::ostringstream oss; 
  oss << description_ << ": " << getMilliseconds() << " milliseconds.";
  return oss.str();
}
...
{
  std::ostringstream oss; 
  oss << description_ << ": " << getSeconds() << " seconds.";
  return oss.str();
}
...
{
  std::ostringstream oss; 
  oss << description_ << ": " << getMinutes() << " minutes.";
  return oss.str();
}
...
{
  std::ostringstream oss; 
  oss << description_ << ": " << getHours() << " hours.";
  return oss.str();
}
...
void HighResTimer::toTimeLog(std::string name, std::string time_str)
{
  const std::string& log_out_folder = "../../output/";
